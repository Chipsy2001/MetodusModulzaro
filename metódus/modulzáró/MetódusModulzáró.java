package metódus.modulzáró;

public class MetódusModulzáró {
    ...
    private static void osszegBemut() {
    ...
    private static void linKerBemut() {
